...
Buxoro (Buxara) toponimi ilk bor Soʻgʻd yozuvlari bilan Buxoroda zarb qilingan mis tangalarida tilga olingan (milodiy IV-V asrlar)`,
    ...
    return (
        <div>
            ...
            <div className="fod1">
                {
                    data1.map((itme, index) => (
                        <Fotapi key={index} itme={itme} />
                    ))}
            </div>
            <div className="fod2">
                {
                    data2.map((itme, index) => (
                        <Fotapi key={index} itme={itme} />
                    ))}
            </div>
        </div>
